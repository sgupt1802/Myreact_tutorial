    ...
    <div className='w-full h-screen' style={{ backgroundColor: color }}>
      <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-3'>
        <div className='flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl'>
          ...
          <button onClick={() => setColor("grey")} className='outline-none px-4 py-2 rounded-full text-white shadow-lg' style={{ backgroundColor: "grey" }} >Grey</button>
          ...
          {/* basically humne onclick function k baare me bhi seekha ki vo ek function expect krta hai na ki ek function ka return  */}
        </div>
      </div>
    </div>
  )
